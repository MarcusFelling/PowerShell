...
$objTemplateObject | Add-Member -MemberType NoteProperty -Name PercentAD -Value $null
$objTemplateObject | Add-Member -MemberType NoteProperty -Name PercentAMS -Value $null
...
[uri] $GetTeamURI = "$AzureDevOpsBaseURL/_apis/projects/GRiDS/teams/AMS/members" + "?api-version=$apiVersion"
...
ForEach($Issue in $Issues){   
    ...
    If($relatedWorkItems){
        ...
        If($objTemp.ATeam -gt 0 -OR $objTemp.BTeam -gt 0){
            ...
            $objTemp.WITeam = $GetIssueWorkItemResponse.fields.'Aon.Team'
...
$Fragment1 = $objResult | 
Select-Object -Property @{n="Issue Work Item ID";e={$_.WIID}},@{n="Issue Work Item Name";e={$_.WIName}},@{n="Created Date";e={$_.WICreatedDate}},@{n="Created By";e={$_.WICreatedBy}},@{n="Closed Date";e={$_.WIClosedDate}},@{n="Area Path";e={$_.WIAreaPath}},@{n="Team";e={$_.WITeam}},@{n="% AD";e={$_.PercentAD}},@{n="% AMS";e={$_.PercentAMS}},@{n="Total Hours AD";e={$_.ATeam}},@{n="Total Hours AMS";e={$_.BTeam}} |
